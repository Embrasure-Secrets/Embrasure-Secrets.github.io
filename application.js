...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const highlightSection = (li, a) => {
    ...
    li.style.color = "#f2ab29";
    a.style.color = "#f2ab29";
  };
  ...
  const handleNavColors = () => {
    ...
    if (isWideScreen && !onMain && topNavVisible) {
      styleNavColors("#f2ab29", "#282828", "#383838");
      changeImgSrc(
        "bam-logo",
        "https://embrasure.s3.us-east-1.amazonaws.com/logo.png"
      ); // black
    } else {
      styleNavColors("#282828", "#f2ab29", "#f2ab29");
      changeImgSrc(
        "bam-logo",
        "https://embrasure.s3.us-east-1.amazonaws.com/logo.png"
      );
